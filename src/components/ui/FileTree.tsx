...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "h-full w-px bg-slate-100 absolute left-1.5 rtl:right-1.5 py-3 rounded-md hover:bg-slate-300 duration-300 ease-in-out dark:bg-slate-800",
        className
      )}
      {...props}
    />
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(
            ...
            className,
            {
              "bg-slate-100 rounded-md dark:bg-slate-800":
